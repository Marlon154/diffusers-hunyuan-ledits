...
try:
    ...
    _import_structure["semantic_stable_diffusion"] = ["SemanticStableDiffusionPipeline", "SemanticStableDiffusion3Pipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    ...
    try:
        ...
        from .semantic_stable_diffusion import SemanticStableDiffusionPipeline, SemanticStableDiffusion3Pipeline
